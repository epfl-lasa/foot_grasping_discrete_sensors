#ifndef _ROS_custom_msgs_gripper_SharedGraspingMsg_h
#define _ROS_custom_msgs_gripper_SharedGraspingMsg_h
...
namespace custom_msgs_gripper
{
  ...
  class SharedGraspingMsg : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "custom_msgs_gripper/SharedGraspingMsg"; };
    virtual const char * getMD5() override { return "4afbdc5e920e43fbe4c39aa7aa6b83cd"; };
